            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(reason == 0)
                    {
                        ...
                        endCall();
                        Intent intent = new Intent(VideoCall.this,VideoCallJoining.class);
...
//        sendLog();
    ...
    private void sendLog() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Url+"/omegle_clone/log/"+channelName, new Response.Listener<String>() {
            @Override
...
//            handler.removeCallbacks(runnable);
    ...
    public void getRemotename(){
        RequestQueue queue = Volley.newRequestQueue(VideoCall.this);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Url + "/users/" + getIntent().getStringExtra("uid2") + "?format=json", new com.android.volley.Response.Listener<String>() {
