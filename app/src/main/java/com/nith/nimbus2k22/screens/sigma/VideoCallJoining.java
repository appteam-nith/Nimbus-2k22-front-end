...
public class VideoCallJoining extends AppCompatActivity {
    ...
    private String Url ="https://appteam.monuk7735.cf/";
    Button videoJoin;
    TextView remainingT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(VideoCallJoining.this);
        if(getIntent().hasExtra("uid2") && getIntent().hasExtra("channel"))
        {
            ViewGroup viewGroup = findViewById(android.R.id.content);
            final View dialogView = LayoutInflater.from(VideoCallJoining.this).inflate(R.layout.custom_dialog_report, viewGroup, false);
            ...
            report_true.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!reason_for_reporting.isEmpty() && reason_for_reporting.length() != 0) {
                        RequestQueue requestQueue = Volley.newRequestQueue(VideoCallJoining.this);
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Url + "omegle_clone/report/", new Response.Listener<String>() {
                            @Override
...
//                            RequestQueue queue =  Volley.newRequestQueue(VideoCallJoining.this);
...
//                    .show();
    ...
    private void getUserId() {
        ...
        uid = auth.getUid();
        Log.d("firebase ID", "getUserId: "+uid);
        if (!uid.isEmpty()) {
            Log.e("UID", uid);
            getChannelNameAndTokenId();
        } else {
